    ...
    public class eGoatDDDContextFactory
    {
        public static eGoatDDDDbContext Create()
        {
            ...
            context.Products.AddRange(new[] {
                new Product { Id = 1, CategoryId = 1, Name = "Cash", Amount = 150, Description = "Test 1", Picture = null, Created = DateTime.Now, Updated = DateTime.Now, Discontinued = false},
                new Product { Id = 2, CategoryId = 1, Name = "Cash", Amount = 150, Description = "Test 1", Picture = null, Created = DateTime.Now, Updated = DateTime.Now, Discontinued = false},
                new Product { Id = 3, CategoryId = 1, Name = "Cash", Amount = 150, Description = "Test 1", Picture = null, Created = DateTime.Now, Updated = DateTime.Now, Discontinued = false},
            });

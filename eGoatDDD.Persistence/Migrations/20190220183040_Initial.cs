        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlaughterDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoatBirth", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Goat_Births",
                        column: x => x.GoatId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    GoatId = table.Column<long>(nullable: false),
                    isMom = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoatParent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GoatParent_Goats_GoatId",
                        column: x => x.GoatId,
                        principalTable: "Goats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Service = table.Column<string>(type: "ntext", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoatService", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Goat_Services",
                        column: x => x.GoatId,
                        principalTable: "Goats",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoatBirth_GoatId",
                table: "GoatBirth",
                column: "GoatId");

            migrationBuilder.CreateIndex(
                name: "IX_GoatParent_GoatId",
                table: "GoatParent",
                column: "GoatId");

            migrationBuilder.CreateIndex(
                name: "IX_Goats_BreedId",
                table: "Goats",
                column: "BreedId");

            migrationBuilder.CreateIndex(
                name: "IX_Goats_ColorId",
                table: "Goats",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_GoatService_GoatId",
                table: "GoatService",
                column: "GoatId");
